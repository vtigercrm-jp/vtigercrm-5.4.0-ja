...
<tr>
	<td>
		...
		<tr class='lvtColData'>
			<td rowspan='2' width='11%'><img src="{'set-IcoLoginHistory.gif'|@vtiger_imageurl:$THEME}" border=0></td>
			<td style='border-bottom: 1px solid rgb(204, 204, 204);' nowrap='nowrap' width='70%'>
				<span class='genHeaderSmall'>{'LBL_THERE_IS_NO_HISTORY_AVAILABLE'|@getTranslatedString:$MODULE}</span>
			</td>
		</tr>
		</table>
	</td>
